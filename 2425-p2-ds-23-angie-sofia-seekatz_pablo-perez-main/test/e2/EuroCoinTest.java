...
public class EuroCoinTest {
    ...
    private static EuroCoin e1, e2, e3, e4, e5, e6, e7, e8;
    ...
    static void setUp(){
        ...
        e4 = new EuroCoin( null,
                ColorType.Oro, EuroCountryType.Belgium,  //nula y año no valido
                "Marmota", 0);
        ...
        e6 = new EuroCoin(EuroValue.EURO200,
                ColorType.Oro_Plata,
                EuroCountryType.Belgium,
                "Arbol", 2003);

        e7 = new EuroCoin(EuroValue.EURO200,
                ColorType.Oro_Plata,
                EuroCountryType.Belgium,
                "Balon", 2003);

        e8 = new EuroCoin(EuroValue.EURO200,
                ColorType.Oro_Plata,
                EuroCountryType.Belgium,
                "Balon", 2003);
    ...
    @Test
    void compareTo() {
        assertEquals(-1, e1.compareTo(e2)); //va al reves y si lo tocas te cargas sortedCoins (orden natural)
        assertEquals(1, e2.compareTo(e1));
        assertEquals(0, e1.compareTo(e3));
        assertEquals(-1, e1.compareTo(e6));
        assertEquals(1, e2.compareTo(e7));
        assertEquals(-1, e6.compareTo(e7));
        assertEquals(0, e7.compareTo(e8));
    }
}
