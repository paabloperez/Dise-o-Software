...
class AdTest {
    ...
    void isPropertyEqual() {
        ...
        assertTrue(a5.isPropertyEqual(a4));
        assertTrue(a6.isPropertyEqual(a1));
    }
    ...
    void testHashCode() {
        ...
        assertEquals(a1.hashCode(), a6.hashCode());
        assertNotEquals(a4.hashCode(), a5.hashCode());
        assertNotEquals(a4.hashCode(), p3.hashCode());
    }
